...
const About = (props: any) => {
	...
	const blog = props.data.allContentfulPost.edges[lastIndex].node;
	return (
		<div className="About">
			<SEO
			...
			<Section title="A little about me">
				<p>
					...
					application doing mainly web infrastructure work. This can be anything
					from repository management and instrumenting telemetry services, to
					fostering best practices and pairing with other engineers to help them
					do their job more efficiently!
				</p>
				<p>
					The story of how I came across web development is actually quite
					interesting. It began all the way back when I was fifteen when I first
					learned about it at a computer camp in New York. If you want the full
				...
				<p>
					Outside of that, I love to read, play my ukulele, and play intramural
			...
			<Section title="Technologies and Mantra">
				...
				<p>
					...
					using NodeJS for a bit, and after a ton of time growing as a developer
					...
					even more which has led me to explore languages like Scala and Elixir.
				</p>

				<p>
					My mantra is <b>Keep it Sleek, but Simple</b>. Human nature leads us
					as consumers to take the path of least resistance. This is why finding
					the motivation to go the gym, sticking to a diet, or learning a new
					technology can seem like such an <b>arduous task</b>.{' '}
				</p>
				...
				<p>
					...
					and visitors will feel a sense of serenity. and maybe even a sense of
					amazement about why your website is so pleasing to use. Google talks
					about this extensively in their Material Design guidelines.
				</p>
			...
			<Section className="about-section-last" title="Contact Me">
				...
				<p>
					...
					for updates on projects I'm working on and my opinions on things going
					on with web development, entrepreneurship, and sometimes even finance.
				</p>
			</Section>
			<Footer blog={blog} />
		</div>
