		...
		return (
			<Layout location={this.props.location}>
				<div className="About">
					...
					<Section
						title={`"Creativity is a breed of history and perspective."`}
					>
						<p>
							I've realized that anything innovative has stemmed from an
							original idea that someone else had. Taking something that is
							great, and remaking into something that is your own is an amazing
							feeling, and that's why I've fallen in love with web development.
						</p>
					</Section>
					<Section title="A little about me">
						<p>
							I am currently a <b>Full Stack Engineer at Meetup</b>. I work on
							the core Meetup product - aka the Groups team, and work on
							everything from new product features to exploring new platform
							integrations for our web engineers.
						</p>
						<p>
						...
						<p>
							...
							intramural sports. As of late, I am exploring the daunting world
							of writing.
						</p>
					</Section>
					<Section title="Technologies and Mantra">
						<p>
							...
							including HTML5, CSS3, and JavaScript as well as popular
							JavaScript libraries such as React and NodeJS, and frameworks like
							Angular and Ember.
						</p>
						...
						<p>
							My mantra is <b>Keep it Sleek, but Simple</b>. Human nature leads
							us as consumers to take the path of least resistance. This is why
							finding the motivation to go the gym, sticking to a diet, or
							learning a new technology can seem like such an{' '}
							<b>arduous task</b>.{' '}
						</p>
						...
						<p>
							Create designs that are simple and replicate the world you live
							in, and visitors will feel a sense of serenity. and maybe even a
							sense of amazement about why your website is so pleasing to use.
							Google talks about this extensively in their Material Design
							guidelines.
						</p>
					...
					<Section className="about-section-last" title="Contact Me">
						...
						<p>
							...
							going on with web development, entrepreneurship, and sometimes
							even finance.
						</p>
					</Section>
